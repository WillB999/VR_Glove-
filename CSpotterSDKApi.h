...
CSPDLL_API INT CSpotter_GetResultCmdModel(HANDLE hCSpotter, INT *pnModelID, INT *pnTagID);
...
CSPDLL_API INT CSpotter_SetNumStatePartialCheck(HANDLE hCSpotter, INT nNumState);
...
CSPDLL_API INT CSpotter_AGC_Enable(HANDLE hCSpotter, INT bEnable);
