...
// -------------------------------------------------------------------------------------------------------------------------------
#define ULTRAIO_FW_CURVE_ENABLE		(1)	// 1:enable UltrIO enable firmware pwm curve, 0:disable UltrIO enable firmware pwm curve
#define ULTRAIO_HW_CURVE_ENABLE		(1)	// 1:enable UltrIO enable hardware pwm curve, 0:disable UltrIO enable hardware pwm curve
