...
#ifndef __CSPOTTERSDTRAIN16_API_H
#define __CSPOTTERSDTRAIN16_API_H
...
CSPDLL_API HANDLE CSpotterSD16_Init(BYTE *lpbyCYBase, BYTE *lpbyMemPool, INT nMemSize, INT *pnErr);

// Purpose: Destroy a trainer (free resources)
// hCSpotter(IN): a handle of the trainer
// Return: Success or error code
CSPDLL_API INT CSpotterSD16_Release(HANDLE hCSpotter);

CSPDLL_API INT CSpotterSD16_GetMemoryUsage(BYTE *lpbyCYBase, INT bEnableSpeakerMode);

// Purpose: Reset trainer
// hCSpotter(IN): a handle of the trainer
// Return: Success or error code
CSPDLL_API INT CSpotterSD16_Reset(HANDLE hCSpotter);
...
// Return: Success or error code
CSPDLL_API INT CSpotterSD16_AddUttrStart(HANDLE hCSpotter, INT nUttrID, char *lpszDataBuf, INT nBufSize);

CSPDLL_API INT CSpotterSD16_AddUttrStartForSpeaker(HANDLE hCSpotter);
...
CSPDLL_API INT CSpotterSD16_AddSample(HANDLE hCSpotter, SHORT *lpsSample, INT nNumSample);

// Purpose: Finish the adding process
// hCSpotter(IN): a handle of the trainer
// Return: Success or error code
CSPDLL_API INT CSpotterSD16_AddUttrEnd(HANDLE hCSpotter);
...
// Return: Success or error code
CSPDLL_API INT CSpotterSD16_GetUttrEPD(HANDLE hCSpotter, INT *pnStart, INT *pnEnd);

CSPDLL_API INT CSpotterSD16_DifferenceCheck(HANDLE hCSpotter, INT nDiffChkLevel);
...
// Return: Success or error code
CSPDLL_API INT CSpotterSD16_TrainWord(HANDLE hCSpotter, char *lpszModelAddr, INT nBufSize, INT nTagID, INT nRejLevel, INT *pnUsedSize);
CSPDLL_API INT CSpotterSD16_TrainWordForSpeaker(HANDLE hCSpotter, char *lpszModelAddr, INT nBufSize, INT nTagID, INT *pnUsedSize);

CSPDLL_API INT CSpotterSD16_DeleteWord(HANDLE hCSpotter, char *lpszModelAddr, INT nBufSize, INT nTagID, INT *pnUsedSize);

CSPDLL_API INT CSpotterSD16_GetCmdID(char *lpszModelAddr, INT nTagID);
CSPDLL_API INT CSpotterSD16_GetTagID(char *lpszModelAddr, INT nCmdID);
...
CSPDLL_API INT CSpotterSD16_SimilarityCheck(HANDLE hCSpotter, char *lpszModelAddr, INT nSimChkLevel);

#ifdef __cplusplus
}
#endif

#endif // __CSPOTTERSDTRAIN16_API_H
